  ...
  return (
    <div className="cmp min-h-screen" style={{ background: "var(--paper)" }}>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-6 py-3">
          ...
          <div className="hidden sm:block">
            <p className="ey" style={{ color: "var(--teal)" }}>HR · Administration</p>
          ...
          <div className="ml-auto flex items-center gap-3">
            <div className="hidden text-right md:block">
              ...
              <p className="mono" style={{ fontSize: 9.5, color: "#707892" }}>{session?.email}</p>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-6">
        ...
        <div className="mb-5">
          ...
          <p style={{ color: "var(--soft)", fontSize: 12.5, marginTop: 1 }}>
            Compliance configs, submissions and pending AI reviews
          </p>
        </div>
          ...
          <div className="max-w-2xl">
            <Card className="p-6">
              <h2 className="dp" style={{ fontSize: 16, fontWeight: 700 }}>
                Upload SOP / Compliance Config
              </h2>
              <p className="mb-6 mt-1" style={{ color: "var(--soft)", fontSize: 13 }}>
                Attach a file for AI parsing, or fill in the form manually.
              </p>

              {/* Step 1 */}
              <div className="mb-5">
                <Eyebrow className="mb-2 flex items-center gap-1.5">
                  <Building2 className="h-3.5 w-3.5" /> Step 1 — Target Department
                </Eyebrow>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <FormField label="Title">
                    <input
                      ...
                      placeholder={`e.g. ${selectedDept} AML Acknowledgement Q3`}
      ...
      <style>{`
        ...
        .cmp .ghost-btn:hover{border-color:#BDC3D0;background:var(--paper);color:var(--ink)}
        .cmp .th-cell{
