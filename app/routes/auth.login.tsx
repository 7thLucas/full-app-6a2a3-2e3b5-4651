...
export default function LoginRoute() {
  ...
  const welcomeMessage = config?.loginWelcomeMessage ?? "Welcome to ComplianceIQ";
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
          ...
          <p className="text-sm text-slate-500 mb-6">{welcomeMessage}</p>
          ...
          <Form method="post" className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:border-[#0066CC] transition-colors"
              />
            </div>
            ...
            <button
              ...
              className="w-full bg-[#0066CC] text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-[#0055AA] focus:outline-none focus:ring-2 focus:ring-[#0066CC] focus:ring-offset-2 transition-colors disabled:opacity-60"
            >
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Secure compliance management for regulated financial institutions
        </p>
      </div>
    </div>
  );
